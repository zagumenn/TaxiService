...
#         gender = 1 if self.ManButton.isChecked() else 2
#         phone = f"+7{self.textNumbers_1.text()}{self.textNumbers_2.text()}{self.textNumbers_3.text()}"
#         role_id = 1  # Здесь нужно указать id роли пользователя
#
#         result = user.registration(fullname, log, password, gender, phone, role_id)
#         print(result)
#
#
#
...
#     import sys
#     appReg = QtWidgets.QApplication(sys.argv)
#     MainWindow = QtWidgets.QMainWindow()
#     ui = Ui_MainWindow()
#     ui.setupUi(MainWindow)
#     MainWindow.show()
#     sys.exit(appReg.exec_())
